                    ...
                    <div class="container">
                        <div class="menu-area__inner">
                            <div class="mobile-nav-toggler align-items-center">
                                <div class="site-ligo">
                                    <a href="{{ route('main') }}"><img src="assets/images/logo/logo.png" alt="site-logo"></a>
                                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h1 style="color:#16a571;">Thank You</h1>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P4SHTSSZ"
