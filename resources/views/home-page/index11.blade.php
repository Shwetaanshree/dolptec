            ...
            <div class="container-fluid">
                ...
                <div class="slider">
                    <div class="slide-track">
                        <div class="slide">
                            <img src="{{ asset('assets/images/non-native-logo/ansible.png') }}" height="100" width="250" alt="" />
                        </div>
                        <div class="slide">
                            <img src="{{ asset('assets/images/non-native-logo/docker.png') }}" height="100" width="250" alt="" />
                        </div>
                        <div class="slide">
                            <img src="{{ asset('assets/images/non-native-logo/java.png') }}" height="100" width="250" alt="" />
                        </div>
                        <div class="slide">
                            <img src="{{ asset('assets/images/non-native-logo/kubernetes.png') }}" height="100" width="250" alt="" />
                        </div>
                        <div class="slide">
                            <img src="{{ asset('assets/images/non-native-logo/microsoft.png') }}" height="100" width="250" alt="" />
                        </div>
                        <div class="slide">
                            <img src="{{ asset('assets/images/non-native-logo/powershell.png') }}" height="100" width="250" alt="" />
                        </div>
                        <div class="slide">
                            <img src="{{ asset('assets/images/non-native-logo/pulumi.png') }}" height="100" width="250" alt="" />
                        </div>
                        <div class="slide">
                            <img src="{{ asset('assets/images/non-native-logo/python.png') }}" height="100" width="250" alt="" />
                        </div>
                        <div class="slide">
                            <img src="{{ asset('assets/images/non-native-logo//snyk (2).png') }}" height="100" width="250" alt="" />
                        </div>
                        <div class="slide">
                            <img src="{{ asset('assets/images/non-native-logo/terraform.png') }}" height="100" width="250" alt="" />
                        </div>
                        <div class="slide">
                            <img src="{{ asset('assets/images/non-native-logo/vault.png') }}" height="100" width="250" alt="" />
                        </div>
                        <div class="slide">
                            <img src="{{ asset('assets/images/native-logo/1.png') }}" height="100" width="250" alt="" />
                        </div>
                        <div class="slide">
                            <img src="{{ asset('assets/images/native-logo/2.png') }}" height="100" width="250" alt="" />
                        </div>
                        <div class="slide">
                            <img src="{{ asset('assets/images/native-logo/3.png') }}" height="100" width="250" alt="" />
                        </div>
                        <div class="slide">
                            <img src="{{ asset('assets/images/native-logo/4.png') }}" height="100" width="250" alt="" />
                        </div>
                        <div class="slide">
                            <img src="{{ asset('assets/images/native-logo/5.png') }}" height="100" width="250" alt="" />
                        </div>
                        <div class="slide">
                            <img src="{{ asset('assets/images/native-logo/6.png') }}" height="100" width="250" alt="" />
                        </div>
                        <div class="slide">
                            <img src="{{ asset('assets/images/native-logo/7.png') }}" height="100" width="250" alt="" />
                        </div>
                        <div class="slide">
                            <img src="{{ asset('assets/images/native-logo/8.png') }}" height="100" width="250" alt="" />
                        </div>
                    </div>
                </div>
                ...
                <div class="service-row-1 d-none d-lg-block">
                  <div class="service-item"><a class="service-content" href="#">
                      ...
                      <div class="service-item"><a class="service-content" href="#">
                          <div class="service-bg"></div>
                          <div class="service-icon">
                              <img src="{{ asset('assets/images/non-native-logo/snyk (2).png') }}">
                          </div>
                          </a></div>
                                        ...
                                        <div class="testimonials">
                                            ...
                                            <div class="images_box">
                                                <div class="testimonial_img">
                                                    <img src="{{ asset('assets/images\team\team1.png') }}" class="img-center"/>
                                    ...
                                    <li class="blog-sidebar-box-item blog-item d-sm-flex wow fadeInUp"
                                        ...
                                        <p>The cloud provides a platform on which businesses can innovate faster.
                                            ...
                                            <div class="btn-box">
                                                ...
                                                <button class="btn thm-btn" onclick="openForm('aws-ebook-build-run-applications.pdf')"><span class="txt">Download Brochure</span></button>
                                            </div>
                                        </div>
                                    </li>
                                      ...
                                      <p> with guidance from Google Cloud’s ebook. It includes:
                                        ...
                                        - Examples of successful migrations from companies like Twitter, Evernote, and Etsy</p>
                                            ...
                                            <div class="btn-box">
                                                ...
                                                <button class="btn thm-btn" onclick="openForm('your_journey_to_the_cloud_google_cloud_smb.pdf')"><span class="txt">Download Brochure</span></button>
                                ...
                                <ul>
                                    ...
                                    <div class="content-box">
                                        ...
                                        <div class="btn-box">
                                            ...
                                            <button class="btn thm-btn" onclick="openForm('Migrate-to-cloud.pdf')"><span class="txt">Download Brochure</span></button>
                                    ...
                                    <li class="blog-sidebar-box-item blog-item d-sm-flex wow fadeInUp"
                                        ...
                                        <div class="content-box">
                                            ...
                                            <div class="btn-box">
                                                ...
                                                <button class="btn thm-btn" onclick="openForm('SMB - PMC - Ebook - Simplify Cloud Migration and Modernization_SEP.pdf')"><span class="txt">Download Brochure</span></button>
                                            </div>
                                        </div>
                                    </li>
...
<div id="popup" class="popup">
    <div class="popup-content">
        ...
        <form action="{{ route('downloadPdf') }}" method="POST" class="contact-form1" id="home-enquire-form1">
            {!! csrf_field() !!}
            <h5 class="title">Book your free consultation today !!</h5>
            <div>
            ...
            <div class="submit-button-wrapper">
                <button type="submit" class="btn thm-btn"><span class="txt">Submit</span></button>
            </div>
        </form>
    </div>
</div>
