...
Route::post('/download-brochure', [DownloadBrochureController::class, 'store'])->name('downloadBrochure');


Route::get('/leads-dashboard', [DownloadBrochureController::class, 'showLeads'])->name('leadsDashboard');

Route::delete('download-delete-multiple', [DownloadBrochureController::class, 'deleteMultiple'])->name('leadsDashboard.delete.multiple');

Route::get('downloadleadsview/{id}', [EnquireController::class, 'downloadleadsview'])->name('downloadleadsview');
