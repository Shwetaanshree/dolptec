...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/accordian.css') }}">
...
<body class="body-dark-bg">
                                                    ...
                                                    <ul class="navigation">
                                                        <li class="menu-item">
                                                            ...
                                                            <!-- <ul class="sub-menu">
                                                                    ...
                                                                    <li>
                                                                        <a href='home3.html'>Home Three</a>
                                                                    </li>
                                                                </ul> -->
                                                        </li>
                                                        <li>
                                                        ...
                                                        <li class="menu-item">
                                                            <a href="#"><span class="highlight1">DolpTec</span> Modules</a>
                                                        </li>
    ...
    <div class="fix">
                            ...
                            <div class="hero-feature-img feature-one br-style1">
                                <form action="{{ route('enquires') }}" method="POST" class="contact-form"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <input class="form-control m-width" type="tel" id="phone1"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <select id="designation" name="designation" class="form-control"
                                                        ...
                                                        data-gtm-form-interact-field-id="0" style="height: 50px;"
                                                        required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        <input class="form-control m-width" id="country_selector1"
                                                            name="country" type="text">
                                                        <label for="country_selector1" style="display:none;">Select a
                                                            country here...</label>
                                                    </div>
                                                    <div class="form-group" style="display:none;">
                                                        <input type="text" id="country_selector_code1"
                                                            class="form-control" name="country_selector_code1"
                                                            data-countrycodeinput="1"
                                                            placeholder="Selected country code will appear here" />
                                                        <label for="country_selector_code1">...and the selected country
        ...
        <section class="service-sec sec-ptb">
            <div id="services-acc-desk" class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 tab-col-gap">
                        <section id="wrapper">
                            <div class="content">
                                <div class="tabs">
                                    <button class="tablinks active" data-country="FinOps" onmouseover="openCity(event, 'FinOps')">
                                        <p data-title="FinOps">FinOps</p>
                                    </button>
                                    <button class="tablinks" data-country="Cloud-Consulting" onmouseover="openCity(event, 'Cloud-Consulting')">
                                        <p data-title="Cloud-Consulting">Cloud Consulting</p>
                                    </button>
                                    <button class="tablinks" data-country="Cloud-Landing-Environment" onmouseover="openCity(event, 'Cloud-Landing-Environment')">
                                        <p data-title="Cloud-Landing-Environment">Cloud Landing Environment (Zone)</p>
                                    </button>
                                    <button class="tablinks" data-country="Architecture-and-Migration-Services" onmouseover="openCity(event, 'Architecture-and-Migration-Services')">
                                        <p data-title="Architecture-and-Migration-Services">Architecture and Migration Services</p>
                                    </button>
                                    <button class="tablinks" data-country="DevOps-Services" onmouseover="openCity(event, 'DevOps-Services')">
                                        <p data-title="DevOps-Services">DevOps Services</p>
                                    </button>
                                    <button class="tablinks" data-country="Workplace-Transformation" onmouseover="openCity(event, 'Workplace-Transformation')">
                                        <p data-title="Workplace-Transformation">IT & Cloud Managed Support</p>
                                    </button>
                                    ...
                                    <div class="flex-row">
                                       <div class="col-lg-7">
                                          ...
                                          <ul>
                                             ...
                                             <ol>
                                                <li>Inform phase :- Identify cost, usage and efficiency data
                                                   points.</li>
                                                <li>Optimise phase :- Identify opportunities to improve cost and
                                                   usage.</li>
                                                <li>Operate phase :- Implement identified opportunities and
                                                   iterate on the
                                       ...
                                       <div class="col-lg-5">
                                          <img class="hero-feature-img feature-one br-style1" src="assets/images/cloud-finops.png" />
                                       </div>
                                 ...
                                 <div id="Cloud-Consulting" class="tabcontent">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-lg-5">
                                          <img class="hero-feature-img feature-one br-style1" src="assets/images/services-2.png" />
                                       </div>

                                    </div>
                                 </div>

                                 <div id="Cloud-Landing-Environment" class="tabcontent">
                                    <h3>Cloud Landing environment (Zone) services</h3>

                                    <h4>Our service helps organisations to build and optimise a Secure, Scalable,
                                       and Compliant cloud environment for various business objectives. </h4><br>
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-lg-7">
                                          ...
                                          <h6>Application migration, Modernisation, Transformation, Disaster
                                             Recovery, Backup management.</h6>
                                          <br>
                                          <h5>We are cloud agnostic and offer landing zone implementation across
                                             all major public and private cloud operators.</h5>
                                          <h6>Includes both cloud native and non-native.</h6>
                                          <ul>
                                       ...
                                       <div class="col-lg-5">
                                          <img class="hero-feature-img feature-one br-style1" src="assets/images/services-3.png" />
                                       </div>

                                    </div>
                                 </div>

                                 <div id="Architecture-and-Migration-Services" class="tabcontent">
                                    ...
                                    <h4>Our Architecture service offers design solutions for business applications
                                       ...
                                       patterns and delivers on your business requirements of </h4><br>

                                    <div class="row">

                                       <div class="col-lg-7">

                                          <h5>Data Privacy, Security, Resiliency, High Availability, Performance
                                             efficiency, Operational excellence</h5>
                                          <h6>Patterns </h6>
                                          <p>Layered Multi-tier, Event driven, Client - Server, Microservices,
                                             Containers/portable,
                                             Serverless cloud native
                                          </p>
                                          <h6>Migration service</h6>
                                          <p>Moving applications and data to the cloud is a complex endeavour,
                                             ...
                                             journey.</p>
                                          <h6>Key benefits of moving to cloud</h6>
                                          <ul>
                                       ...
                                       <div class="col-lg-5">
                                          <img class="hero-feature-img feature-one br-style1" src="assets/images/services-4.png" />
                                       </div>

                                    </div>
                                 </div>

                                 <div id="DevOps-Services" class="tabcontent">
                                    <h3>DevOps Services</h3>

                                    <h4>In today's digital era, a business competitive advantage relies on an
                                       efficient cloud, data and application delivery process. </h4><br>

                                    <div class="row">

                                       <div class="col-lg-7">

                                          <h5>We provide a comprehensive devops service which helps organisations
                                             to gain agility and consistency across their software delivery cycle
                                             to achieve faster business results.</h5>
                                          <p>We offer cloud native, non-native or a combination of both devops
                                             service with industry proven tools & languages </p>
                                          <p>Layered Multi-tier, Event driven, Client - Server, Microservices,
                                             Containers/portable,
                                             Serverless cloud native
                                          </p><br>
                                       ...
                                       <div class="col-lg-5">
                                          <img class="hero-feature-img feature-one br-style1" src="assets/images/services-5.png" />
                                       </div>

                                    </div>
                                 </div>

                                 <div id="Workplace-Transformation" class="tabcontent">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-lg-5">
                                          <img class="hero-feature-img feature-one br-style1" src="assets/images/services-6.png" />
                                       </div>
        ...
        <section id="technology" class="service-sec bg-light-greem sec-ptb">
                                            ...
                                            <div class="aon-servi-box">
                                                <div class="aon-servi-inr">
                                                    <div class="aon-servi-icon">
                                                        <img src="{{ asset('assets/images/non-native-logo/ansible.png') }}"/>
                                                    </div>
                                    ...
                                    <div class="item">
                                        <div class="aon-servi-box-wrap aon-icon-effect  wow fadeInDown" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeInDown;">
                                            <div class="aon-servi-box">
                                                <div class="aon-servi-inr">
                                                    <div class="aon-servi-icon">
                                                        <img src="{{ asset('assets/images/non-native-logo/java.png') }}"/>
                                                    </div>
                                    ...
                                    <div class="item">
                                        <div class="aon-servi-box-wrap aon-icon-effect  wow fadeInDown" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeInDown;">
                                            <div class="aon-servi-box">
                                                <div class="aon-servi-inr">
                                                    <div class="aon-servi-icon">
                                                        <img src="{{ asset('assets/images/non-native-logo/microsoft.png') }}"/>
                                                    </div>
                                    ...
                                    <div class="item">
                                        <div class="aon-servi-box-wrap aon-icon-effect  wow fadeInDown" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeInDown;">
                                            <div class="aon-servi-box">
                                                <div class="aon-servi-inr">
                                                    <div class="aon-servi-icon">
                                                        <img src="{{ asset('assets/images/non-native-logo/powershell.png') }}"/>
                                                    </div>
                                    ...
                                    <div class="item">
                                        <div class="aon-servi-box-wrap aon-icon-effect  wow fadeInDown" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeInDown;">
                                            <div class="aon-servi-box">
                                                <div class="aon-servi-inr">
                                                    <div class="aon-servi-icon">
                                                        <img src="{{ asset('assets/images/non-native-logo/pulumi.png') }}"/>
                                                    </div>
                                    ...
                                    <div class="item">
                                        <div class="aon-servi-box-wrap aon-icon-effect  wow fadeInDown" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeInDown;">
                                            <div class="aon-servi-box">
                                                <div class="aon-servi-inr">
                                                    <div class="aon-servi-icon">
                                                        <img src="{{ asset('assets/images/non-native-logo/python.png') }}"/>
                                                    </div>
                                    ...
                                    <div class="item">
                                        <div class="aon-servi-box-wrap aon-icon-effect  wow fadeInDown" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeInDown;">
                                            <div class="aon-servi-box">
                                                <div class="aon-servi-inr">
                                                    <div class="aon-servi-icon">
                                                        <img src="{{ asset('assets/images/non-native-logo/snyk.png') }}"/>
                                                    </div>
                                    ...
                                    <div class="item">
                                        <div class="aon-servi-box-wrap aon-icon-effect  wow fadeInDown" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeInDown;">
                                            <div class="aon-servi-box">
                                                <div class="aon-servi-inr">
                                                    <div class="aon-servi-icon">
                                                        <img src="{{ asset('assets/images/non-native-logo/Terraform.png') }}"/>
                                                    </div>
                                    ...
                                    <div class="item">
                                        <div class="aon-servi-box-wrap aon-icon-effect  wow fadeInDown" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeInDown;">
                                            <div class="aon-servi-box">
                                                <div class="aon-servi-inr">
                                                    <div class="aon-servi-icon">
                                                        <img src="{{ asset('assets/images/non-native-logo/kubernetes.png') }}"/>
                                                    </div>
                                    ...
                                    <div class="item">
                                        <div class="aon-servi-box-wrap aon-icon-effect  wow fadeInDown" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeInDown;">
                                            <div class="aon-servi-box">
                                                <div class="aon-servi-inr">
                                                    <div class="aon-servi-icon">
                                                        <img src="{{ asset('assets/images/non-native-logo/Vault.png') }}"/>
                                                    </div>
                                    ...
                                    <div class="item">
                                        <div class="aon-servi-box-wrap aon-icon-effect  wow fadeInDown" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeInDown;">
                                            <div class="aon-servi-box">
                                                <div class="aon-servi-inr">
                                                    <div class="aon-servi-icon">
                                                        <img src="{{ asset('assets/images/non-native-logo/docker.png') }}"/>
                                                    </div>
                                    ...
                                    <div class="item">
                                        <div class="aon-servi-box-wrap aon-icon-effect  wow" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeIn;">
                                            <div class="aon-servi-box">
                                                <div class="aon-servi-inr">
                                                    <div class="aon-servi-icon">
                                                        <img src="{{ asset('assets/images/native-logo/1.png') }}"/>
                                                    </div>
                                    ...
                                    <div class="item">
                                        <div class="aon-servi-box-wrap aon-icon-effect  wow" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeIn;">
                                            <div class="aon-servi-box">
                                                <div class="aon-servi-inr">
                                                    <div class="aon-servi-icon">
                                                        <img src="{{ asset('assets/images/native-logo/2.png') }}"/>
                                                    </div>
                                    ...
                                    <div class="item">
                                        <div class="aon-servi-box-wrap aon-icon-effect  wow" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeIn;">
                                            <div class="aon-servi-box">
                                                <div class="aon-servi-inr">
                                                    <div class="aon-servi-icon">
                                                        <img src="{{ asset('assets/images/native-logo/3.png') }}"/>
                                                    </div>
                                    ...
                                    <div class="item">
                                        <div class="aon-servi-box-wrap aon-icon-effect  wow fadeIn" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeIn;">
                                            <div class="aon-servi-box">
                                                <div class="aon-servi-inr">
                                                    <div class="aon-servi-icon">
                                                        <img src="{{ asset('assets/images/native-logo/4.png') }}"/>
                                                    </div>
                                    ...
                                    <div class="item">
                                        <div class="aon-servi-box-wrap aon-icon-effect  wow fadeIn" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeIn;">
                                            <div class="aon-servi-box">
                                                <div class="aon-servi-inr">
                                                    <div class="aon-servi-icon">
                                                        <img src="{{ asset('assets/images/native-logo/5.png') }}"/>
                                                    </div>
                                    ...
                                    <div class="item">
                                        <div class="aon-servi-box-wrap aon-icon-effect  wow fadeIn" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeIn;">
                                            <div class="aon-servi-box">
                                                <div class="aon-servi-inr">
                                                    <div class="aon-servi-icon">
                                                        <img src="{{ asset('assets/images/native-logo/6.png') }}"/>
                                                    </div>
                                    ...
                                    <div class="item">
                                        <div class="aon-servi-box-wrap aon-icon-effect  wow fadeIn" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeIn;">
                                            <div class="aon-servi-box">
                                                <div class="aon-servi-inr">
                                                    <div class="aon-servi-icon">
                                                        <img src="{{ asset('assets/images/native-logo/7.png') }}"/>
                                                    </div>
                                    ...
                                    <div class="item">
                                        <div class="aon-servi-box-wrap aon-icon-effect  wow fadeIn" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeIn;">
                                            <div class="aon-servi-box">
                                                <div class="aon-servi-inr">
                                                    <div class="aon-servi-icon">
                                                        <img src="{{ asset('assets/images/native-logo/8.png') }}"/>
                                                    </div>
            ...
            <div class="vertical-sec-title">
                <h2 class="aon-title text-black text-center">Technologies We've Worked on</h2>
            </div>
        </section>
                    ...
                    <div class="col-lg-6">
                        <div class="sec-images">
                            <div class="sec-img-one overflow-hidden wow fadeInLeft" data-wow-delay="500ms"
                                ...
                                <img src="{{ asset('assets/images/about/about01.png" alt="about-img') }}" />
                            </div>
                            <div class="sec-img-two overflow-hidden wow fadeInRight" data-wow-delay="500ms"
                                data-wow-duration="1500ms">
                                <img src="{{ asset('assets/images/about/about02.png" alt="about-img') }}" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="section-content">
                    ...
                    <div class="section-head">
                        <!-- <span class="aon-sub-title text-white">Our Services List</span> -->
                            ...
                            <h2 class="aon-title text-black text-center">Unleash your full potential with DolpTec</h2>

                        <h5 class="text-black text-center p-b20">Experience the whole new next level of service, at a competitive price.</h5>
                    </div>
                    <!--Title Section End-->
                                ...
                                <div class="item">
                                    <div class="aon-servi-box-wrap aon-icon-effect  wow fadeInDown" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeInDown;">
                                        <div class="aon-servi-box">
                                            <div class="aon-servi-inr">
                                                <div class="aon-servi-icon">
                                                    <img src="{{ asset('assets/images/services-icon/icon-1.png') }}">
                                                </div>
                                ...
                                <div class="item">
                                    <div class="aon-servi-box-wrap aon-icon-effect  wow fadeInDown" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeInDown;">
                                        <div class="aon-servi-box">
                                            <div class="aon-servi-inr">
                                                <div class="aon-servi-icon">
                                                    <img src="{{ asset('assets/images/services-icon/icon-2.png') }}">
                                                </div>
                                ...
                                <div class="item">
                                    <div class="aon-servi-box-wrap aon-icon-effect  wow fadeInDown" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeInDown;">
                                        <div class="aon-servi-box">
                                            <div class="aon-servi-inr">
                                                <div class="aon-servi-icon">
                                                    <img src="{{ asset('assets/images/services-icon/icon-3.png') }}">
                                                </div>
                                ...
                                <div class="item">
                                    <div class="aon-servi-box-wrap aon-icon-effect  wow fadeInDown" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeInDown;">
                                        <div class="aon-servi-box">
                                            <div class="aon-servi-inr">
                                                <div class="aon-servi-icon">
                                                    <img src="{{ asset('assets/images/services-icon/icon-4.png') }}">
                                                </div>
                                ...
                                <div class="item">
                                    <div class="aon-servi-box-wrap aon-icon-effect  wow fadeInDown" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeInDown;">
                                        <div class="aon-servi-box">
                                            <div class="aon-servi-inr">
                                                <div class="aon-servi-icon">
                                                    <img src="{{ asset('assets/images/services-icon/icon-6.png') }}">
                                                </div>
                                ...
                                <div class="item">
                                    <div class="aon-servi-box-wrap aon-icon-effect  wow fadeInDown" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeInDown;">
                                        <div class="aon-servi-box">
                                            <div class="aon-servi-inr">
                                                <div class="aon-servi-icon">
                                                    <img src="{{ asset('assets/images/services-icon/icon-7.png') }}">
                                                </div>
                                ...
                                <div class="item">
                                    <div class="aon-servi-box-wrap aon-icon-effect  wow fadeInDown" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeInDown;">
                                        <div class="aon-servi-box">
                                            <div class="aon-servi-inr">
                                                <div class="aon-servi-icon">
                                                    <img src="{{ asset('assets/images/services-icon/icon-8.png') }}">
                                                </div>
                                ...
                                <div class="item">
                                    <div class="aon-servi-box-wrap aon-icon-effect  wow fadeInDown" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeInDown;">
                                        <div class="aon-servi-box">
                                            <div class="aon-servi-inr">
                                                <div class="aon-servi-icon">
                                                    <img src="{{ asset('assets/images/services-icon/icon-9.png') }}">
                                                </div>
                                ...
                                <div class="item">
                                    <div class="aon-servi-box-wrap aon-icon-effect  wow fadeInDown" data-wow-duration="2000ms" style="visibility: visible; animation-duration: 2000ms; animation-name: fadeInDown;">
                                        <div class="aon-servi-box">
                                            <div class="aon-servi-inr">
                                                <div class="aon-servi-icon">
                                                    <img src="{{ asset('assets/images/services-icon/icon-10.png') }}">
                                                </div>
...
<!-- service icon section ends -->
        ...
        <section class="project-sec sec-pb">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="sec-content">
        ...
        <!-- blog section start -->
        <section class="blog-sec sec-ptb">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="sec-content mb-5">
                        ...
                        <div class="blog-sidebar-box">
                            <ul>
                                <li class="blog-sidebar-box-item blog-item d-sm-flex wow fadeInUp"
                                    ...
                                    <div class="img-box">
                                        <img src="{{ asset('assets/images/blog/blog-s1.png') }}" alt="blog" />
                                    </div>
                                ...
                                <li class="blog-sidebar-box-item blog-item d-sm-flex wow fadeInUp"
                                    ...
                                    <!-- blog sidebar box item 1 -->
                                    <div class="img-box">
                                        <img src="{{ asset('assets/images/blog/blog-s3.png') }}" alt="blog" />
                                    </div>
                                    <div class="content-box">
                    ...
                    <div class="col-lg-6">
                        <div class="blog-sidebar-box">
                            <ul>
                                ...
                                <div class="img-box">
                                    <img src="{{ asset('assets/images/blog/blog-s2.png') }}" alt="blog" />
                                </div>
                                <div class="content-box">
                                ...
                                <li class="blog-sidebar-box-item blog-item d-sm-flex wow fadeInUp"
                                    ...
                                    <!-- blog sidebar box item 2 -->
                                    <div class="img-box">
                                        <img src="{{ asset('assets/images/blog/blog-s4.png') }}" alt="blog" />
                                    </div>
                                    <div class="content-box">
                                        <!-- <div class="meta-box">
   ...
   <div id="popup" class="popup" style="display: none;">
       ...
       <div class="popup-content">
           ...
           <form method="post" class="contact-form1" id="contact-form" action="thank-you.html">
               ...
               <div class="submit-button-wrapper">
                   <button type="submit" class="btn thm-btn" id="submit-form-button"> <span class="txt">Submit</span></button>
               </div>
           </form>
       </div>
   </div>
